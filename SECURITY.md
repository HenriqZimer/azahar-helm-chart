...
When deploying Azahar using this Helm chart:
...
4. **Updates**
   ...
   - Monitor security advisories for the upstream [linuxserver/docker-azahar](https://github.com/linuxserver/docker-azahar) image.
